...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.frame_offset = 0
        #=== Test ===
        self.load_origin_rgba_geom = False
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        #=== Perceptual loss ===
        #self.lambda_dperceptual = 0
        self.lambda_dperceptual = 0.2
        #=== Edge loss ===
        self.lambda_dedge = 0.2
        self.lambda_dedge_2 = 0.1
        self.lambda_dedge_3 = 0.8
        ...
        #=== Test ===
        self.densification_interval_ljy = 100
        self.densify_from_iter_ljy = 500
        self.densify_until_iter_ljy = 15_000
