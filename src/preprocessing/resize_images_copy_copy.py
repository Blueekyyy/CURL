...
def main(args):
    ...
    if os.path.exists(f'{data_path}/iqa_filtered_names.pkl'):
        ...
        # === Test ===
        #img_names = os.listdir(f'{data_path}/input')
        img_names = os.listdir(f'{data_path}/images_save')
    ...
    for img_name in tqdm(img_names):
        ...
        # === Test ===
        #img = np.asarray(Image.open(f'{data_path}/input/{img_name}'))
        #img = np.asarray(Image.open(f'{data_path}/images_save/{img_name}'))
