...
def main(args, dataset):
    ...
    #=== Test ===
    #path2 = os.path.join(args.model_path, 'point_cloud', f'iteration_{args.iter}')
    ...
    #=== Test ===
    #xyz_hair = torch.nan_to_num(xyz_hair, nan=0.0)
    #gaussians_hair._xyz = xyz_hair
    #gaussians_hair.save_ply(os.path.join(path2, 'point_cloud_nan_replaced.ply'))
