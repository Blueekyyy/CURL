...
class Camera(nn.Module):
    def __init__(self, colmap_id, R, T, FoVx, FoVy,
                 width, height,
                 image, mask_body, mask_hair, orient_angle, orient_conf, depth, pct_loss, edge_loss,
                 image_name, uid,
        ...
        self.original_pct_loss = pct_loss.to(self.data_device)
        self.original_edge_loss = edge_loss.to(self.data_device)
