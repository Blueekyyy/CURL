...
#obj = bpy.data.objects[head_object_name]
#set_material(obj, bpy.data.materials['Main'])
#obj.scale = (obj.scale[0] * 0.6,
#             obj.scale[1] * 0.6,
#             obj.scale[2] * 0.6)
...
if len(argv) >= 3:
    ...
    #hair = hair[np.random.choice(len(hair), n_strands, replace=True)]
    ...
    def create_hair(name: str, block_id: int):
        ...
        def create_points(curveData, coords, index=0):
            ...
            for i, coord in enumerate(coords):
                ...
                #polyline.points[index].co = (x-0.05, y-0.05, z-0.05, i)
                index += 1
...
for camera_idx, camera_ob in enumerate(camera_obs):
    ...
    # === Test ===
    #shutil.move('image1877.png', f'{exp_path}/%06d.png' % camera_idx)